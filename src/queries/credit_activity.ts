...
export const creditActivityQuery = (db: Db, lastUpdated?: number) => {
  const cursor = db.collection("credit_activity").find(
...
export const creditActivityTransform = (doc: Document) => {
